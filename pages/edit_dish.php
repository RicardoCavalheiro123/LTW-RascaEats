...
<body>
    ...
    <div class = "editInf">
    <form action="../actions/restaurant_edit_server.php?id=<?php echo $restaurant->restaurantId;?>&dish=<?php echo $dish->dishId;?>" method="post" class="logout" enctype ="multipart/form-data">
        <div class="row">
